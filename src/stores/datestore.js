...
export default class TurfDateStore {
    ...
    */
    ...
    @computed get firstThumbDate() {
        let thumb_count = this.stores.models.model.dashboard.thumbs.count;
        return this.lastValidDate.clone().subtract(thumb_count-1, 'd');
    }
    ...
    @action updateDboardIndexes() {
        ...
        let last_idx = this.indexForDate(this.lastValidDate);
